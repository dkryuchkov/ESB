namespace DCP.ESB.Schemas {
    ...
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "status", XPath = @"/*[local-name()='root' and namespace-uri()='http://DCP.ESB.Schemas.DCFUpdateStatusMessage']/*[local-name()='status' and namespace-uri()='http://DCP.ESB.Schemas.DCFUpdateStatusMessage']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "error", XPath = @"/*[local-name()='root' and namespace-uri()='http://DCP.ESB.Schemas.DCFUpdateStatusMessage']/*[local-name()='error' and namespace-uri()='http://DCP.ESB.Schemas.DCFUpdateStatusMessage']", XsdType = @"string")]
    ...
    public sealed class DCFUpdateStatusMessage : Microsoft.XLANGs.BaseTypes.SchemaBase {
    ...
    <xs:annotation>
      <xs:appinfo>
        <b:properties>
          ...
          <b:property distinguished=""true"" xpath=""/*[local-name()='root' and namespace-uri()='http://DCP.ESB.Schemas.DCFUpdateStatusMessage']/*[local-name()='status' and namespace-uri()='http://DCP.ESB.Schemas.DCFUpdateStatusMessage']"" />
          <b:property distinguished=""true"" xpath=""/*[local-name()='root' and namespace-uri()='http://DCP.ESB.Schemas.DCFUpdateStatusMessage']/*[local-name()='error' and namespace-uri()='http://DCP.ESB.Schemas.DCFUpdateStatusMessage']"" />
        </b:properties>
      </xs:appinfo>
    </xs:annotation>
    <xs:complexType>
